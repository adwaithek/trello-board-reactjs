...
function Home() {
    ...
    useEffect(()=>{
        ...
        onSnapshot(q,(onSnapshot)=>{
            setLists(onSnapshot.docs.map((doc)=>{
                return{
                    id:doc.id,...doc.data(),
                }
...
const onDragEnd=async(result)=>{
    ...
    return (
        <StoreApi.Provider  value={{addMoreCard,addMoreList,updateListTitle,removeCard,updateCardTitle,deleteList}}>
